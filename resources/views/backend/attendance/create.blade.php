...
@section('content')
    <div class="create">
        ...
        <div class="flex items-center justify-between mb-6">
            <div>
                <h2 class="text-gray-700 uppercase font-bold">Absence</h2>
            </div>
        ...
        <div class="w-full mt-8 bg-white rounded">
            ...
            <div class="w-full px-6 py-6">
                <div class="flex items-center bg-gray-200 rounded-tl rounded-tr">
                    ...
                    <div class="w-3/12 text-left text-gray-600 py-2 px-4 font-semibold">numero</div>
                    <div class="w-5/12 text-right text-gray-600 py-2 px-4 font-semibold">Absence</div>
                </div>
                <form action="{{ route('teacher.attendance.store') }}" method="POST">
                    ...
                    @endforeach
                    <div class="mt-6">
                        <button class="shadow bg-red-500 hover:bg-blue-400 focus:shadow-outline focus:outline-none text-white font-bold py-2 px-4 rounded" type="submit">
                            Ajouter
                        </button>
                    </div>
                </form>
