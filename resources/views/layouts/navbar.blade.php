<div class="bg-red-700 px-4 sm:px-6 py-3 flex items-center justify-between shadow h-16 fixed top-0 left-0 right-0 z-50">
    <div class="flex items-center text-white">
        ...
        <span class="font-semibold  text-sm sm:text-xl tracking-tight"> LP : I A M </span>
    </div>
    <div class="relative"> 
        @auth
            ...
            <div class="bg-red-600 absolute top-0 right-0 mt-12 -mr-6 shadow rounded-bl rounded-br">
